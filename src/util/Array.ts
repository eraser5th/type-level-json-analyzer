type ArraySkipInner<T extends unknown[], N extends number, Acc extends never[]> = T extends [unknown, ...infer R]
  ? Acc["length"] extends N
  ? T
  : ArraySkipInner<R, N, [...Acc, never]>
  : [];

export type ArraySkip<T extends unknown[], N extends number> = ArraySkipInner<T, N, []>;
